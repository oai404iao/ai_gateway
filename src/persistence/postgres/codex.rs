...
use super::super::codex::{
    CodexCredentialBatchInput, CodexCredentialBatchOperation, CodexCredentialCreate,
    CodexCredentialExportBundle, CodexCredentialExportInput, CodexCredentialExportItem,
    CodexCredentialExportProxy, CodexCredentialRecord, CodexCredentialUpdateInput,
    CodexCredentialView, CodexOauthFlowRecord, CodexOauthStartInput, CodexQuotaResetOutcome,
    CodexQuotaUpdate, CodexQuotaWindowHistory, CodexQuotaWindowPeriodView, CodexTokenRefreshUpdate,
    SelfCodexQuotaCredentialView, SelfCodexQuotaWindowHistory, SelfCodexQuotaWindowPeriodView,
};
...
impl_postgres_from_row!(CodexCredentialExportProxy {
    proxy_key,
    name,
    proxy_url,
    username,
...
impl_postgres_from_row!(CodexOauthFlowRecord {
    id,
    actor_user_id,
    channel_group_id,
    label,
...
impl_postgres_from_row!(CodexCredentialRecord {
    channel_id,
    channel_group_id,
    connector_pool_id,
    projection_channel_ids,
    label,
    email,
    account_id,
    user_id,
...
impl_postgres_from_row!(CodexCredentialView {
    id,
    channel_group_id,
    label,
    email,
    ...
    primary_window_seconds,
    primary_reset_at,
    primary_window_cost_amount,
    secondary_used_percent,
    secondary_window_seconds,
    secondary_reset_at,
    secondary_window_cost_amount,
    quota_reset_credits_available,
    quota_checked_at,
    last_error_code,
    last_error_summary,
...
impl_postgres_from_row!(CodexQuotaWindowPeriodView {
    id,
    credential_id,
    window_kind,
    window_seconds,
...
impl_postgres_from_row!(SelfCodexQuotaCredentialView {
    id,
    name,
    channel_group_id,
    plan_type,
...
impl_postgres_from_row!(SelfCodexQuotaWindowPeriodView {
    window_kind,
    window_seconds,
    started_at,
    scheduled_reset_at,
