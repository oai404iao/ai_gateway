...
describe("Channel configuration", () => {
  it("groups channels and shows capabilities only for the selected channel", async () => {
    const secondChannel = { ...LOGICAL_CHANNEL, id: "00000000-0000-4000-8000-000000000099", name: "Second channel" };
    server.use(
    ...
    await waitFor(() => expect(window.location.pathname).toBe("/admin/routing/capabilities/new"));
    expect(new URLSearchParams(window.location.search).get("channel")).toBe(LOGICAL_CHANNEL.id);
