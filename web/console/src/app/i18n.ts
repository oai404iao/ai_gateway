...
const zhCN: Record<string, string> = {
  ...
  "Remaining": "剩余",
  "Reset time": "重置时间",
  "Creating a sharing group immediately restricts all keys in the selected user group, even while paused. Bindings cannot be undone in this version. Use a dedicated user group.": "创建后立即限制所选用户组的全部 Key，暂停状态也不例外。本版本不支持撤销绑定，请使用专门的用户组。",
