...
const zhCN: Record<string, string> = {
  ...
  "Group saved": "组已保存",
  "Could not save routing group.": "无法保存路由组。",
  "Group deleted": "组已删除",
  "Could not delete routing group.": "无法删除路由组。",
  "Routing group": "路由组",
  ...
  "Delete group": "删除组",
  "Delete this routing group?": "确认删除该路由组？",
  ...
  "A channel binds authentication to one access. Shared accesses and credentials are never deleted with it.": "渠道把一个接入与认证绑定。共享的接入和凭据不会随渠道删除。",
  "Channel settings": "渠道设置",
  "Credentials are reusable identities. Rebinding changes connection identity without touching routes.": "凭据是可复用的身份。改绑会改变连接身份，但不会修改路由。",
  "Pick an access": "选择接入",
  "Choose an access": "选择接入",
  "Choose a credential": "选择凭据",
  "Capabilities and routing candidates must be withdrawn separately.": "接口能力和路由候选需要单独撤下。",
  "Delete this logical channel?": "确认删除该逻辑渠道？",
  "The channel is soft-deleted. Shared accesses and credentials are kept.": "渠道将被软删除，共享的接入与凭据会保留。",
  "Pick a channel": "选择渠道",
  "Choose a group": "选择组",
  ...
  "Declared here; enabled, routed, and granted separately.": "仅在此声明；启用、路由和授权分别独立管理。",
  "Transports": "传输方式",
  ...
  "Routing candidates referencing this capability must be withdrawn first.": "必须先撤下引用此接口能力的路由候选。",
  "Delete capability": "删除接口能力",
  "Delete this capability?": "确认删除该接口能力？",
  "The capability is soft-deleted after dependent routes are withdrawn.": "撤下依赖路由后，接口能力将被软删除。",
  ...
  "General": "通用",
  "Transports are fixed by the operation. Saving never grants API key access.": "传输方式由操作决定，保存能力不会授予 API Key 访问权限。",
  ...
  "Manage groups, their logical channels, and each channel's operation capabilities.": "配置渠道组、按组管理逻辑渠道，并设置各渠道的操作能力。",
  ...
  "Authorization uses a fixed capability set. Later additions are not granted automatically.":
    "授权使用固定的能力集合，之后新增的能力不会自动获得授权。",
