...
const zhCN: Record<string, string> = {
  ...
  "This user group is bound to Codex sharing and cannot be deleted.": "该用户组已绑定 Codex 拼车，不能删除。",
  ...
  "Credential and user group cannot be changed after creation.": "创建后不可更换绑定的凭证和用户组。",
